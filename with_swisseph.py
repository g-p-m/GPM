...
objects = [swe.MOON, swe.SUN, swe.INTP_APOG]  # The first one is the target point: distribution of it in the sectors starting from startPoint is displayed
...
#plt.show()  # 52 lines, including 12 non-essential: empty lines, assertions, and #-disabled lines
